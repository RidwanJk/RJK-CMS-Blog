...
<body style="background-color: var(--bs-gray-900);" id="home">
  ...
  <div class="container-fluid bd-layout p-0">
              ...
              <div id="submenu-admin" class="accordion-collapse collapse show">
                <div class="accordion-body p-0 px-3">
                  <div class="list-group list-group-flush">
                    ...
                    <a href="pages/user/" class="list-group-item list-group-item-action border-0 mb-1 text-bg-dark" data-bs-placement="right" data-bs-title="Settings">
    ...
    <main class="bd-main p-3 bg-light">
      <?php include 'pages/homepage/p_article.php';
      $articlesum = countArticles();
      $categorysum = countCategories();
      $usersum = userCount();
      ?>
      <!-- RECAPS -->
      <div class="row">
        <div class="col-12 col-lg">
          <div class="card text-bg-primary mb-3">
            <div class="card-body">
              ...
              <p class="fs-1"><?= $articlesum ?></p>
              <a href="pages/article/" class="text-white">See more</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-lg">
          <div class="card text-bg-secondary mb-3">
            <div class="card-body">
              ...
              <p class="fs-1"><?= $categorysum ?></p>
              <a href="pages/category/" class="text-white">See more</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-lg">
