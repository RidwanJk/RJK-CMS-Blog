...
<head>
  ...
  <script>
    function confirmDelete(category_id) {
      document.getElementById('deleteCategoryId').value = category_id;
    ...
    <header class="bd-header shadow z-3">
      ...
      <nav class="bg-white p-3">
        <h5 class="m-0">
          ...
          <a href="#home" class="text-dark text-decoration-none">Category</a>
        </h5>
      </nav>
      <!-- END OF NAVBAR -->
                  ...
                  <tbody>
                    ...
                    foreach ($categories as $category) : ?>
                      <tr>
                        ...
                        <td><?= $category->name; ?></td>
                        <td>
                          <a href="./edit.php?id=<?= htmlspecialchars($category->id) ?>" class="btn btn-warning mb-1"><i class="bi bi-pencil"></i></a>                          
                          <button type="button" onclick="confirmDelete(<?= $category->id; ?>)" class="btn btn-danger"><i class="bi bi-trash"></i></button>
                        </td>
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="deleteForm" action="p_category.php" method="POST">
