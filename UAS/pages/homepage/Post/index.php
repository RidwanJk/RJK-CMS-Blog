  ...
  <div class="container-fluid bd-layout p-0">
    ...
    <header class="bd-header shadow z-3">
      ...
      <nav class="bg-white p-3">
        <h5 class="m-0">
          ...
          <a href="#home" class="text-dark text-decoration-none">Article</a>
        </h5>
      </nav>
      <!-- END OF NAVBAR -->
      <?php session_start();
              ...
              <div id="submenu-admin" class="accordion-collapse collapse show">
                <div class="accordion-body p-0 px-3">
                  <div class="list-group list-group-flush">
                    ...
                    <a href="index.php" class="list-group-item list-group-item-action border-0 mb-1 text-bg-dark active " data-bs-placement="right" data-bs-title="Dashboard">
                      <i class="bi bi-speedometer me-3"></i>
                      <span class="submenu-title">Dashboard</span>
                    </a>

                    <a href="create.php" class="list-group-item list-group-item-action border-0 mb-1 text-bg-dark " data-bs-placement="right" data-bs-title="Form">
    ...
    <main class="bd-main p-3 bg-light">
      ...
      <div class="card">
        <div class="card-body">
          <div class="mb-3">
            <a href="./create.php" class="btn btn-primary"><i class="bi bi-plus"></i>New Article</a>
          </div>
                  ...
                  <tbody>
                    ...
                    foreach ($articles as $article) : ?>
                      <tr>
                        ...
                        <td>
                        <a href="../../article/edit.php?id=<?= htmlspecialchars($article->id) ?>" class="btn btn-warning mb-1"><i class="bi bi-pencil"></i></a>
                        <a href="../../detail/index.php?id=<?= htmlspecialchars($article->id) ?>" class="btn btn-info mb-1"><i class="bi bi-eye"></i></a>
                          <form action="p_article.php" method="POST">
                            <input type="hidden" name="action" value="delete">
                            <input type="hidden" name="article_id" value="<?= $article->id; ?>">
                            <button type="button" onclick="confirmDelete(<?= $article->id; ?>)" class="btn btn-danger" data-bs-target="#deleteModal"><i class="bi bi-trash"></i></button>
                          </form>
                        </td>
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <!-- Delete Form -->
          <form id="deleteForm" action="p_article.php" method="POST">
            <input type="hidden" name="action" value="delete">
