                  ...
                  <tbody>
                    ...
                    foreach ($articles as $article) : ?>
                      <tr>
                        ...
                        <td>
                          <a href="./edit.php?id=<?= htmlspecialchars($article->id) ?>" class="btn btn-warning mb-1"><i class="bi bi-pencil"></i></a>
                          <a href="../detail/index.php?id=<?= $article->id ?>" class="btn btn-info mb-1"><i class="bi bi-eye"></i></a>
