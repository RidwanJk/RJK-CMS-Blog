...
<body style="background-color: var(--bs-gray-900);" id="home">
  ...
  <div class="container-fluid bd-layout p-0">
    ...
    <header class="bd-header shadow z-3">
      ...
      <nav class="bg-white p-3">
        <h5 class="m-0">
          ...
          <a href="#home" class="text-dark text-decoration-none">Edit</a>
        </h5>
      </nav>
      <!-- END OF NAVBAR -->
              ...
              <div id="submenu-admin" class="accordion-collapse collapse show">
                <div class="accordion-body p-0 px-3">
                  <div class="list-group list-group-flush">
                    ...
                    <a href="../homepage/Post/index.php" class="list-group-item list-group-item-action border-0 mb-1 text-bg-dark " data-bs-placement="right" data-bs-title="Dashboard">
    ...
    <main class="bd-main p-3 bg-light">
      <form action="p_article.php" method="POST" enctype="multipart/form-data">
        <div class="card mb-3">
          <div class="card-body">
            ...
            <div class="d-grid d-lg-block gap-2">
              ...
              <a href="../article" class="btn btn-secondary">Cancel</a>
            </div>
          </div>
        </div>
      </form>
